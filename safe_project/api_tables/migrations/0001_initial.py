# Generated by Django 3.1.4 on 2021-06-18 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sanitizer_perc', models.CharField(max_length=8, verbose_name='Sanitizer Percentage')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('co2_level', models.FloatField(blank=True, null=True, verbose_name='CO2 Level')),
                ('co_level', models.FloatField(blank=True, null=True, verbose_name='CO Level')),
                ('metano_level', models.FloatField(blank=True, null=True, verbose_name='Metano Level')),
            ],
        ),
        migrations.CreateModel(
            name='Worker',
        ...
        migrations.AddField(
            model_name='door',
            name='people_inside',
            field=models.ManyToManyField(blank=True, null=True, to='api_tables.Worker'),
        ),
        migrations.AddField(
            model_name='door',
            name='user_id',
